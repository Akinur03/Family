  ...
  return [
    {
      ...
      icon: 'Zap',
      color: '#f59e0b', // amber
      description: 'Electricity, gas, water, and trash collection',
      monthlyBudget: 350,
      isSystem: true,
    ...
    },
    {
      ...
      description: 'Supermarket shopping, organic produce, and pantry restock',
      monthlyBudget: 800,
      isSystem: true,
      createdAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      icon: 'HeartPulse',
      color: '#ec4899', // pink
      description: 'Doctor visits, prescriptions, and health insurance co-pays',
      monthlyBudget: 300,
      isSystem: true,
      createdAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      icon: 'GraduationCap',
      color: '#06b6d4', // cyan
      description: 'School fees, tutoring, textbooks, and supplies',
      monthlyBudget: 500,
      isSystem: true,
      createdAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      icon: 'Car',
      color: '#64748b', // slate
      description: 'Gasoline, EV charging, public transit, and car maintenance',
      monthlyBudget: 250,
      isSystem: true,
      createdAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      icon: 'Wallet',
      color: '#059669', // green
      description: 'Salary deposits, bonuses, and family pool contributions',
      monthlyBudget: 6000,
      isSystem: true,
      createdAt: '2026-01-01T00:00:00.000Z',
    },
  ...
  return [
    {
      ...
      userRole: 'member',
      title: 'Power Grid Monthly Electricity Bill',
      amount: 148.50,
      type: 'expense',
      categoryId: 'cat-util',
      ...
      categoryIcon: 'Zap',
      date: '2026-09-05',
      notes: 'Paid electricity bill for August cycle via online banking.',
    ...
    },
    {
      ...
      userRole: 'member',
      title: 'Gigabit Fiber Internet & Home Mesh Bill',
      amount: 89.99,
      type: 'expense',
      ...
      categoryIcon: 'Wifi',
      date: '2026-09-06',
      notes: 'Monthly high-speed internet subscription for study and family work-from-home.',
    ...
    },
    {
      ...
      userName: 'Eleanor Pendelton',
      userRole: 'member',
      title: 'Weekly Supermarket Family Groceries',
      amount: 215.75,
      type: 'expense',
      ...
      date: '2026-09-07',
      notes: 'Whole Foods trip: fresh veggies, milk, meat, olive oil and pantry staples.',
    ...
    },
    {
      ...
      userName: 'Lucas Pendelton',
      userRole: 'member',
      title: 'University Engineering Lab Manuals & Courseware',
      amount: 165.00,
      type: 'expense',
      ...
      date: '2026-09-08',
      notes: 'Required lab materials and software license for Fall semester.',
    ...
    },
    {
      ...
      userRole: 'admin',
      title: 'Primary Monthly Salary Family Deposit',
      amount: 4200.00,
      type: 'income',
      ...
      categoryIcon: 'Wallet',
      date: '2026-09-01',
      notes: 'Net payroll credited to joint family expenditure vault.',
      status: 'approved',
      reviewedBy: 'usr-admin',
      reviewedByName: 'Arthur Pendelton',
    ...
    },
    {
      ...
      userName: 'Lucas Pendelton',
      userRole: 'member',
      title: 'Express Car Oil Change & Tire Rotation',
      amount: 110.00,
      type: 'expense',
      ...
      categoryIcon: 'Car',
      date: '2026-09-04',
      notes: 'Routine service for the shared family sedan before road trip.',
      status: 'rejected',
      reviewedBy: 'usr-admin',
      reviewedByName: 'Arthur Pendelton',
      reviewedAt: '2026-09-05T12:00:00.000Z',
      reviewNotes: 'Receipt was missing line-item service details. Please upload the official invoice from the garage.',
